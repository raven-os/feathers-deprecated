...
namespace protocol
{
  void SeatImplem::get_pointer([[maybe_unused]]struct wl_client *client,
  ...
  void SeatImplem::get_keyboard([[maybe_unused]]struct wl_client *client,
          [[maybe_unused]]struct wl_resource *resource,
          [[maybe_unused]]uint32_t id)
  {
  }

  void SeatImplem::get_touch([[maybe_unused]]struct wl_client *client,
          [[maybe_unused]]struct wl_resource *resource,
          [[maybe_unused]]uint32_t id)
  {
  }

  void SeatImplem::release([[maybe_unused]]struct wl_client *client,
          [[maybe_unused]]struct wl_resource *resource)
  {
  }
}
