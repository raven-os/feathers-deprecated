// g++ -o wayland-input wayland-input.c window.cpp -lwayland-client -lwayland-egl -lEGL -lGL -lxkbcommon -I../../include/
...
int main () {
	...
	//WindowHandler *win = new WindowHandler(egl_display, shell, compositor, &window);
	struct window window;
